//! Contains constants for the builder deposit and exit system contracts, first introduced in the
//! Amsterdam hardfork.
//!
...
/// The [Gloas Consensus Specs](https://github.com/ethereum/consensus-specs/blob/master/specs/gloas/beacon-chain.md)
/// defined maximum number of builder deposit requests per payload.
pub const MAX_BUILDER_DEPOSIT_REQUESTS_PER_PAYLOAD: usize = 64;

/// The [Gloas Consensus Specs](https://github.com/ethereum/consensus-specs/blob/master/specs/gloas/beacon-chain.md)
/// defined maximum number of builder exit requests per payload.
