...
/// [EIP-8282](https://eips.ethereum.org/EIPS/eip-8282) builder deposit and exit requests.
#[derive(Debug, Clone, PartialEq, Eq, Default, Serialize)]
#[serde(deny_unknown_fields)]
#[serde(rename_all = "snake_case")]
#[cfg_attr(feature = "ssz", derive(ssz_derive::Decode, ssz_derive::Encode))]
...
mod ssz_requests_conversions {
    ...
    use alloy_eips::{
        ...
        eip8282::{
            ...
            BUILDER_EXIT_REQUEST_TYPE, MAX_BUILDER_DEPOSIT_REQUESTS_PER_PAYLOAD,
                ...
                fn accumulate(mut self, request: &[u8]) -> Result<Self, TryFromRequestsError> {
                    ...
                    match *request_type {
                        ...
                        BUILDER_DEPOSIT_REQUEST_TYPE => {
                            self.builder_deposits = Self::parse_request_payload(
                                payload,
                        ...
                        BUILDER_EXIT_REQUEST_TYPE => {
                            self.builder_exits = Self::parse_request_payload(
                                payload,
                                MAX_BUILDER_EXIT_REQUESTS_PER_PAYLOAD,
                                BUILDER_EXIT_REQUEST_TYPE,
                            )?;
